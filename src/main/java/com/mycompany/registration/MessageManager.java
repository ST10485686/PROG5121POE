...
public class MessageManager {
    ...
    private static void populateDemoData() {
        ...
        sentMessages.add(new Message("Alice", "+27834557896", "Did you get the cake?", "hash001", "msg001"));
        sentMessages.add(new Message("Eve", "0838884567", "it is dinner time", "hash003", "msg003"));

        // Disregarded messages demo data
        disregardedMessages.add(new Message("Mallory", "+27838884567", "Where are you? you are late! i have asked you to be on time.", "hash004", "msg004"));
        disregardedMessages.add(new Message("Trent", "+27834484567", "Yohoooo,I am at your gate", "hash005", "msg005"));

        // Stored messages demo data
        storedMessages.add(new Message("Victor", "+27838884567", "Project files attached.", "hash006", "msg006"));
        storedMessages.add(new Message("Yvonne", "+27838884567", "OK, I am leaving without you.", "hash007", "msg007"));
    }
